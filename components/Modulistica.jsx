export default function Modulistica() {
  ...
  const hrefMailto     = `mailto:${to}?subject=${subject}&body=${body}`; // per Thunderbird (client predefinito)
  ...
  const ThunderbirdIcon = () => (
    <svg className="ico" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
      <path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10.012 10.012 0 0 0 12 2Zm5.1 7.4-4.9 3.7a2 2 0 0 1-2.4 0L4.9 9.4a.8.8 0 0 1 1-1.25l4.9 3.7a.4.4 0 0 0 .5 0l4.9-3.7a.8.8 0 0 1 1 1.25Z"/>
    </svg>
  );
  ...
  return (
    <section className="mod-section">
      <div className="card surface surface--xl text-center">
        ...
        <p className="k-lead">Invia una richiesta: ti risponderemo con i moduli corretti.</p>
        <p className="k-note">(per la <strong>mediazione</strong> usa la sezione dedicata <a className="link-quiet" href="#adr">ADR Europa</a>)</p>

        <div className="k-cta">
          <a href={hrefMailto} className="btn btn-primary btn-lg">Invia una mail alla segreteria</a>
        </div>
        ...
        <div className="k-providers" aria-label="Scegli il tuo servizio di posta">
          ...
          <a href={hrefMailto} className="chip" aria-label="Scrivi con Thunderbird">
            <ThunderbirdIcon/> Thunderbird
          </a>
        </div>
      </div>
    </section>
