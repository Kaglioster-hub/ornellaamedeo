export default function Contatti() {
  return (
    <section className="contacts-section">
      <div className="card surface surface--md text-center">
        ...
        <ul className="contact-list">
          <li className="row">
            ...
            <div className="value">Via Terenzio 21 – Roma</div>
          </li>
          <li className="row">
          ...
          <li className="row">
            <span className="dot">✉️</span>
            <div className="value">
              <strong><a className="link-quiet" href="mailto:segreteria.studioamedeo@gmail.com">segreteria.studioamedeo@gmail.com</a></strong>
            </div>
          </li>
          <li className="row">
            <span className="dot">📮</span>
            <div className="value">PEC: dott.ornella.amedeo@pecodcec.roma.it</div>
          </li>
        </ul>
      </div>
    </section>
